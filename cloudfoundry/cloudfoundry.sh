...
GHA2DB_LOCAL=1 PG_DB=cloudfoundry gha2db 2016-09-01 0 today now 'cloudfoundry,cloudfoundry-attic,cloudfoundry-community,cloudfoundry-incubator,cloudfoundry-samples' 2>>errors.txt | tee -a run.log || exit 2
