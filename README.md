...
Example use:
`ruby analysis.rb data/data_yyyymm.csv projects/projects_yyyymm.csv hints.csv urls.csv defmaps.csv`
...
- projects/projects_YYYYMM.csv --> data generated by analysis.rb from data_YYYYMM.csv using: `hints.csv`, `urls.csv`, `defmaps.csv`


`generate_motion.rb` tool is used to merge data from multiple files into one for motion chart. Usage:
`ruby generate_motion.rb files.csv motion.csv motion_sums.csv`
