...
This tool set processes input (csv files from BigQuery results) to generate data for Bubble/Motion Google Sheet Chart.<br/>The main script is `analysis.rb`
...
- projects/projects_YYYYMM.csv --> data generated by `analysis.rb` based on data_YYYYMM.csv using: `map/`: `hints.csv`, `urls.csv`, `defmaps.csv`, `skip.csv`, `ranges.csv`
