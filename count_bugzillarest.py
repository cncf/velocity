...
parser.add_argument("-T", "--token", help = "Bugzilla token", type=str)
...
bugzilla = BugzillaREST(args.url, user=args.user, password=args.password, api_token=args.token, max_bugs=500, tag=None, archive=None)
# print(bugzilla)
