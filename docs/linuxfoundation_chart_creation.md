...
The chart itself can be generated in a [google sheet](https://docs.google.com/spreadsheets/d/1U-xcXsGSrMkHg8WhmSpYOzQCqr7gwOK3Yz1lF5agYIM/edit?usp=sharing).
...
Run the query for a year, for example: `[DBG=1] ./run_bq_templated.sh lf 20250701 20260701`.

It will generate a file for example: `data/data_lf_projects_20250701_20260701.csv`.
...
```
./tools/enrich_authors/enrich_authors -in data/data_lf_projects_20250701_20260701.csv -out data/data_lf_projects_20250701_20260701.enriched.csv -from 2025-07-01 -to 2026-07-01 -forks lf_forks.json -tmp ./tmp
cp data/data_lf_projects_20250701_20260701.csv data/data_lf_projects_20250701_20260701.raw.csv
cp data/data_lf_projects_20250701_20260701.enriched.csv data/data_lf_projects_20250701_20260701.csv
```
...
- `ruby merger.rb data/data_lf_projects_20250701_20260701.csv data/data_cncf_projects_20250701_20260701.csv`.
...
- Shell into reports pod: `kubectl exec -itn devstats-test devstats-reports -- /bin/bash` and run: `./velocity/linux_commits.sh 2025-07-01 2026-07-01` that will give values for number of pushes and commits. This is not needed but recommended. Otherwise put `0,0` for commits and pushes. Changesets are used to calculate output commits.
- Delete reporting pod: `helm delete devstats-test-reports`.
- Run `./lkml_analysis.rb 2025-07-01 2026-07-01` from `cncf/velocity` to get number of LKML emails (all) and new threads. This takes hours to complete.
...
- `DTFROM=2025-07-01 DTTO=2026-07-01 ./run_multirepo_range.sh`.
...
- Use `./agl_jira.sh '2025-07-01 00:00:00' '2026-07-01 00:00:00'`.
...
- Create a file based on `data/data_agl_projects_20250701_20260701.csv` and apply proper data values
- Run `ruby merger.rb data/data_lf_projects_20250701_20260701.cenriched.sv data/data_agl_projects_20250701_20260701.csv`.
...
[SKIP_TOKENS=''] FORKS_FILE=lf_forks.json ruby analysis.rb data/data_lf_projects_20250701_20260701.csv projects/projects_lf_20250701_20260701.csv map/hints.csv map/urls.csv map/defmaps.csv map/skip.csv map/ranges_sane.csv
```
...
Currently manually check for `oam-dev`, `layer5io` and `pixie-labs` in `projects/projects_lf_20250701_20260701.csv` file: `/oam-dev\|layer5io\|pixie-labs`. Also check for last column being empty `/,""`.
...
- Create `devstats-reports` pod, shell into it and run: `./velocity/update_cncf_projects_commits.sh 2025-07-01 2026-07-01`.
- Download update: `wget https://teststats.cncf.io/backups/data_cncf_update_2025-07-01_2026-07-01.csv`. `mv data_cncf_update_2025-07-01_2026-07-01.csv data/`.
- `ruby update_projects.rb projects/projects_lf_20250701_20260701.csv data/data_cncf_update_2025-07-01_2026-07-01.csv -1`.
- You can also use `PROJFMT=1 ruby update_projects.rb projects/projects_lf_20250701_20260701.csv ./projects/projects_cncf_20250701_20260701.csv -1` instead.


# Yocto

- Add bugzilla data via: `[REST=1] ./yocto_bugzilla.sh '2025-07-01 00:00:00' '2026-07-01 00:00:00'`. Put number of bugzilla issues in `data/data_yocto_bugzilla_20250701_20260701.csv`:
```
project,key,value
Yocto,issues,1865
```
- `ruby update_projects.rb projects/projects_lf_20250701_20260701.csv data/data_yocto_bugzilla_20250701_20260701.csv -1`


# Final chart

Make a copy of the [google doc](https://docs.google.com/spreadsheets/d/1U-xcXsGSrMkHg8WhmSpYOzQCqr7gwOK3Yz1lF5agYIM/edit?usp=sharing).
