...
Run the query for a year, for example: `[DBG=1] ./run_bq_templated.sh lf 20250101 20260101`.
...
```
./tools/enrich_authors/enrich_authors -in data/data_lf_projects_20250101_20260101.csv -out data/data_lf_projects_20250101_20260101.enriched.csv -from 2025-01-01 -to 2026-01-01 -forks lf_forks.json
cp data/data_lf_projects_20250101_20260101.csv data/data_lf_projects_20250101_20260101.raw.csv
cp data/data_lf_projects_20250101_20260101.enriched.csv data/data_lf_projects_20250101_20260101.csv
```
...
- `ruby merger.rb data/data_lf_projects_20250101_20260101.csv data/data_cncf_projects_20250101_20260101.csv`.
...
- A message will be shown: `Data range not found in data/data_linux.csv: 2025-01-01 - 2026-01-01`. That means you need to add a new data range for Linux in file: `data/data_linux.csv`
- Add a row for the time period in `data/data_linux.csv`: `torvalds,torvalds/linux,2025-01-01,2026-01-01,0,0,0,0,0,0,0,0`
	...
	- Go to `cncf/gitdm/src/`, `cd ~/dev/cncf/gitdm/src` and run: `./linux_range.sh 2025-01-01 2026-01-01`
	- While in `cncf/gitdm/src/` directory, view: `vim linux_stats/range_2025-01-01_2026-01-01.txt`:
	```
...
- `DTFROM=2025-01-01 DTTO=2026-01-01 ./run_multirepo_range.sh`.
...
- Use `./agl_jira.sh '2025-01-01 00:00:00' '2026-01-01 00:00:00'`.
...
Currently manually check for `oam-dev`, `layer5io` and `pixie-labs` in `projects/projects_lf_20250101_20260101.csv` file: `/oam-dev\|layer5io\|pixie-labs`. Also check for last column being empty `/,""`.
...
- Create `devstats-reports` pod, shell into it and run: `./velocity/update_cncf_projects_commits.sh 2025-01-01 2026-01-01`.
- Download update: `wget https://teststats.cncf.io/backups/data_cncf_update_2025-01-01_2026-01-01.csv`. `mv data_cncf_update_2025-01-01_2026-01-01.csv data/`.
- `ruby update_projects.rb projects/projects_lf_20250101_20260101.csv data/data_cncf_update_2025-01-01_2026-01-01.csv -1`.
- You can also use `PROJFMT=1 ruby update_projects.rb projects/projects_lf_20250101_20260101.csv ./projects/projects_cncf_20250101_20260101.csv -1` instead.


# Yocto

- Add bugzilla data via: `[REST=1] ./yocto_bugzilla.sh '2025-01-01 00:00:00' '2026-01-01 00:00:00'`. Put number of bugzilla issues in `data/data_yocto_bugzilla_20250101_20260101.csv`:
```
project,key,value
Yocto,issues,1865
```
- `ruby update_projects.rb projects/projects_lf_20250101_20260101.csv data/data_yocto_bugzilla_20250101_20260101.csv -1`
