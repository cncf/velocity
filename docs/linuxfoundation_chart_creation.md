...
Currently manually check for `oam-dev`, `layer5io` and `pixie-labs` in `projects/projects_lf_20250101_20260101.csv` file: `/oam-dev\|layer5io\|pixie-labs`. Also check for last column being empty `/s,""`.
