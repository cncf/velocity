...
- We have a line in `ruby merger.rb data/unlimited.csv data/data_cncf_projects.csv` which needs to be changed to `ruby merger.rb data/unlimited.csv ata/data_cncf_projects_20180401_20190401.csv`
...
- New approach: `./openstack_issues.sh '2018-04-01 00:00:00' '2019-04-01 00:00:00'`. Get data from results - it is terribly slow, almost unusable.
- Update file `data/data_openstack_bugs_20180401_20190401.csv` (copy file from `data/data_openstack_bugs.csv`)
...
- Run `./run_bq.sh apache 2018-04-01 2019-04-01 || echo 'error'` to get Apache data. It will generate `data/data_apache_projects_20180401_20190401.csv` file.
- `ruby merger.rb data/unlimited.csv data/data_apache_projects_20180401_20190401.csv`.
...
- New approach (works, but terribly slow): `./apache_jira.sh '2017-11-01 00:00:00' '2018-11-01 00:00:00'` and/or `./apache_bugzilla.sh '2017-11-01 00:00:00' '2018-11-01 00:00:00'`.
...
- Run `./run_bq.sh libreoffice 2018-04-01 2019-04-01 || echo 'error'` to get LibreOffice data. It will generate `data/data_libreoffice_projects_20180401_20190401.csv` file.
...
- New approach, use: `./libreoffice_bugzilla.sh '2017-11-01 00:00:00' '2018-11-01 00:00:00'` (terribly slow).
...
- New approach: `./freebsd_bugzilla.sh '2018-11-01 00:00:00' '2018-12-01 00:00:00'` (terribly slow).
- Put results here (comments=emails/3 (many of them are automatic)): `./data/data_freebsd_svn_20171101_20181101.csv`
- Finally `ruby update_projects.rb projects/unlimited_both.csv ./data/data_freebsd_svn_20171101_20181101.csv`.
