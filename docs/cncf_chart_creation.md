...
Currently manually check for `oam-dev`, `layer5io` and `pixie-labs` in `projects/projects_cncf_20220701_20230701.csv` file. Also check for last column being empty `/s,""`.
