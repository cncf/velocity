...
```
[SKIP_TOKENS=''] ruby analysis.rb data/data_cncf_projects_20230701_20240701.csv projects/projects_cncf_20230701_20240701.csv map/hints.csv map/urls.csv map/defmaps.csv map/skip.csv map/ranges_sane.csv
```
