...
cp data/data_top30_projects_20210801_20220801.csv data/unlimited.csv
echo "Adding Linux kernel data"
ruby add_linux.rb data/unlimited.csv data/data_linux.csv 2021-08-01 2022-08-01
...
ruby merger.rb data/unlimited.csv data/data_cncf_projects_20210801_20220801.csv
...
ruby merger.rb data/unlimited.csv data/data_cf_projects_20210801_20220801.csv force
echo "Adding/Updating Apache case"
ruby merger.rb data/unlimited.csv data/data_apache_projects_20210801_20220801.csv
echo "Adding/Updating OpenSUSE case"
ruby merger.rb data/unlimited.csv data/data_opensuse_projects_20210801_20220801.csv
...
ruby update_projects.rb projects/unlimited_both.csv ./data/data_freebsd_svn_20210801_20220801.csv -1
echo "Prioritizing LF projects data"
PROJFMT=1 ruby update_projects.rb projects/unlimited_both.csv ./projects/projects_lf_20210801_20220801.csv -1
echo "Prioritizing CNCF projects data"
PROJFMT=1 ruby update_projects.rb projects/unlimited_both.csv ./projects/projects_cncf_20210801_20220801.csv -1
...
cp reports/top_projects_by_*.txt reports/20210801_20220801/
cp reports/*_ranks.txt reports/20210801_20220801/
