...
ruby add_linux.rb data/unlimited.csv data/data_linux.csv 2023-01-01 2024-01-01
...
ruby merger.rb data/unlimited.csv data/data_cncf_projects_20230101_20240101.csv
...
ruby merger.rb data/unlimited.csv data/data_cf_projects_20230101_20240101.csv force
...
ruby merger.rb data/unlimited.csv data/data_opensuse_projects_20230101_20240101.csv
echo "Analysis"
...
ruby update_projects.rb projects/unlimited_both.csv data/data_apache_jira_20230101_20240101.csv -1
echo "Prioritizing LF projects data"
PROJFMT=1 ruby update_projects.rb projects/unlimited_both.csv ./projects/projects_lf_20230101_20240101.csv -1
echo "Prioritizing CNCF projects data"
PROJFMT=1 ruby update_projects.rb projects/unlimited_both.csv ./projects/projects_cncf_20230101_20240101.csv -1
...
mkdir reports/20230101_20240101/
cp reports/top_projects_by_*.txt reports/20230101_20240101/
cp reports/*_ranks.txt reports/20230101_20240101/
