...
cp data/unlimited_output_201701_201712.csv data/unlimited.csv
echo "Adding Linux kernel data"
ruby add_linux.rb data/unlimited.csv data/data_linux.csv 2017-01-01 2018-01-01
echo "Adding GitLab data"
ruby add_external.rb data/unlimited.csv data/data_gitlab.csv 2017-01-01 2018-01-01 gitlab gitlab/GitLab
...
ruby merger.rb data/unlimited.csv data/data_cloudfoundry_201701_201712.csv force
...
ruby merger.rb data/unlimited.csv data/data_cncf_projects_201701_201712.csv
...
echo "Adding/Updating AutomotiveGradeLinux (AGL) case"data_linux
