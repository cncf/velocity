...
PROJFMT=1 ruby update_projects.rb projects/unlimited_both.csv ./projects/projects_lf_20250101_20260101.csv -1
echo "Prioritizing CNCF projects data"
PROJFMT=1 ruby update_projects.rb projects/unlimited_both.csv ./projects/projects_cncf_20250101_20260101.csv -1
...
mkdir reports/20250101_20260101/
cp reports/top_projects_by_*.txt reports/20250101_20260101/
cp reports/*_ranks.txt reports/20250101_20260101/
