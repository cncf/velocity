...
cp data/data_top30_projects_20220101_20230101.csv data/unlimited.csv
echo "Adding Linux kernel data"
ruby add_linux.rb data/unlimited.csv data/data_linux.csv 2022-01-01 2023-01-01
...
ruby merger.rb data/unlimited.csv data/data_cncf_projects_20220101_20230101.csv
...
ruby merger.rb data/unlimited.csv data/data_cf_projects_20220101_20230101.csv force
echo "Adding/Updating Apache case"
ruby merger.rb data/unlimited.csv data/data_apache_projects_20220101_20230101.csv
echo "Adding/Updating OpenSUSE case"
ruby merger.rb data/unlimited.csv data/data_opensuse_projects_20220101_20230101.csv
echo "Analysis"
...
ruby update_projects.rb projects/unlimited_both.csv data/data_apache_jira_20220101_20230101.csv -1
echo "Prioritizing LF projects data"
PROJFMT=1 ruby update_projects.rb projects/unlimited_both.csv ./projects/projects_lf_20220101_20230101.csv -1
echo "Prioritizing CNCF projects data"
PROJFMT=1 ruby update_projects.rb projects/unlimited_both.csv ./projects/projects_cncf_20220101_20230101.csv -1
