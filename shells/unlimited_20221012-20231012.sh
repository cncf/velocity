...
cp data/data_top30_projects_20221012_20231012.csv data/unlimited.csv
echo "Adding Linux kernel data"
ruby add_linux.rb data/unlimited.csv data/data_linux.csv 2022-10-12 2023-10-12
...
ruby merger.rb data/unlimited.csv data/data_cncf_projects_20221012_20231012.csv
...
ruby merger.rb data/unlimited.csv data/data_cf_projects_20221012_20231012.csv force
echo "Adding/Updating Apache case"
ruby merger.rb data/unlimited.csv data/data_apache_projects_20221012_20231012.csv
echo "Adding/Updating OpenSUSE case"
ruby merger.rb data/unlimited.csv data/data_opensuse_projects_20221012_20231012.csv
echo "Analysis"
...
ruby update_projects.rb projects/unlimited_both.csv data/data_apache_jira_20221012_20231012.csv -1
echo "Prioritizing LF projects data"
PROJFMT=1 ruby update_projects.rb projects/unlimited_both.csv ./projects/projects_lf_20221012_20231012.csv -1
echo "Prioritizing CNCF projects data"
PROJFMT=1 ruby update_projects.rb projects/unlimited_both.csv ./projects/projects_cncf_20221012_20231012.csv -1
...
mkdir reports/20221012_20231012/
cp reports/top_projects_by_*.txt reports/20221012_20231012/
cp reports/*_ranks.txt reports/20221012_20231012/
