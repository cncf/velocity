...
then
  ...
  ./run_bq.sh top30 2025-01-01 2025-07-01
...
ruby merger.rb data/unlimited.csv data/data_cf_projects_20240701_20250701.csv force
...
ruby merger.rb data/unlimited.csv data/data_opensuse_projects_20240701_20250701.csv
echo "Analysis"
