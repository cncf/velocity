...
cp data/data_top30_projects_20180401_20190401.csv data/unlimited.csv
...
ruby merger.rb data/unlimited.csv ata/data_cncf_projects_20180401_20190401.csv || exit 1
...
ruby merger.rb data/unlimited.csv data/apache_20180401_20190401.csv || exit 1
