...
cp data/data_top30_projects_20210101_20210701.csv data/unlimited.csv
echo "Adding Linux kernel data"
ruby add_linux.rb data/unlimited.csv data/data_linux.csv 2021-01-01 2021-07-01
...
ruby merger.rb data/unlimited.csv data/data_cncf_projects_20210101_20210701.csv
#echo "Adding GitLab data"
#ruby add_external.rb data/unlimited.csv data/data_gitlab.csv 2021-01-01 2021-07-01 gitlab gitlab/GitLab
...
ruby merger.rb data/unlimited.csv data/data_cf_projects_20210101_20210701.csv force
#echo "Adding/Updating OpenStack case"
#ruby merger.rb data/unlimited.csv openstack/data_openstack_2021-01-01_2021-07-01.csv
echo "Adding/Updating Apache case"
ruby merger.rb data/unlimited.csv data/data_apache_projects_20210101_20210701.csv
#echo "Adding/Updating Chromium case"
#ruby merger.rb data/unlimited.csv data/data_chromium_projects_20210101_20210701.csv
echo "Adding/Updating OpenSUSE case"
ruby merger.rb data/unlimited.csv data/data_opensuse_projects_20210101_20210701.csv
echo "Adding/Updating AGL case"
ruby merger.rb data/unlimited.csv data/data_agl_projects_20210101_20210701.csv
#echo "Adding/Updating LibreOffice case"
#ruby merger.rb data/unlimited.csv data/data_libreoffice_projects_20210101_20210701.csv
echo "Adding/Updating FreeBSD case"
ruby merger.rb data/unlimited.csv data/data_freebsd_projects_20210101_20210701.csv
echo "Analysis"
...
#ruby update_projects.rb projects/unlimited_both.csv data/data_libreoffice_git_20210101_20210701.csv -1
echo "Updating FreeBSD data from SVN logs"
ruby update_projects.rb projects/unlimited_both.csv ./data/data_freebsd_svn_20210101_20210701.csv -1
echo "Prioritizing LF projects data"
PROJFMT=1 ruby update_projects.rb projects/unlimited_both.csv ./projects/projects_lf_20210101_20210701.csv -1
echo "Prioritizing CNCF projects data"
PROJFMT=1 ruby update_projects.rb projects/unlimited_both.csv ./projects/projects_cncf_20210101_20210701.csv -1
...
rm -rf ./reports/20210101_20210701
mkdir ./reports/20210101_20210701
cp projects/unlimited.csv ./reports/top_projects_by_*.txt ./reports/*_projects_ranks.txt ./reports/20210101_20210701/
echo "All done"
